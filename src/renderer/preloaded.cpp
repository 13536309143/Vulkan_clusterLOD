...
// Implements the fully resident scene upload path.
// The code estimates device-local memory, batches uploads, and fills shader geometry records with persistent buffer addresses.
//==============================================================================
