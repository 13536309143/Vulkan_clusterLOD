...
// Declares the hierarchical-Z helper used for occlusion culling.
// The helper manages reduction textures, descriptor state, and push constants for min/max depth pyramid construction.
//==============================================================================
#pragma once
