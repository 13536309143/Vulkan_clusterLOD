...
// Declares the top-level application state machine.
// This class owns scene loading, renderer selection, streaming settings, UI state, readback handling, and per-frame configuration propagation.
//==============================================================================
