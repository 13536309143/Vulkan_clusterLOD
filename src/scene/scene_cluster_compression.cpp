...
// Packs and unpacks cluster group payloads for reduced storage and transfer cost.
// Compression must preserve the shader-visible group layout and fall back cleanly when packed data would violate size or precision constraints.
//==============================================================================
#include <bit>
