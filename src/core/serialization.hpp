...
// Provides small span serializers used by the scene cache format.
// All helpers advance byte addresses explicitly and keep 64-bit alignment stable for memory-mapped reads.
//==============================================================================
#pragma once
