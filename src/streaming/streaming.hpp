...
// Declares the high-level scene streaming controller.
// The controller owns persistent per-geometry metadata, shader buffers, streaming compute pipelines, and per-frame task orchestration.
//==============================================================================
