...
// Core shader ABI definitions for geometry, groups, clusters, render instances, and compact math helpers.
// The same file is included from C++ and GLSL, so scalar layout, field order, and packing widths are part of the binary contract.
//==============================================================================
