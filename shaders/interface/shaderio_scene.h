...
// Scene geometry ABI shared by CPU packing code and GPU traversal/render shaders.
// Addresses and offsets stored here must match the payload layout emitted by scene preprocessing and streaming updates.
//==============================================================================
