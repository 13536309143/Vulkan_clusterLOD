...
// Debug mesh shader that draws instance bounding boxes.
// It expands each selected instance box into line primitives using the same camera constants as the main renderer.
//==============================================================================
#version 460
