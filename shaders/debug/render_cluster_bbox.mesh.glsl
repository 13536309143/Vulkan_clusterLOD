...
// Debug mesh shader that draws cluster bounding boxes for visible or selected clusters.
// It resolves the same group payload metadata as the main cluster renderer to verify traversal and residency results.
//==============================================================================
#version 460
