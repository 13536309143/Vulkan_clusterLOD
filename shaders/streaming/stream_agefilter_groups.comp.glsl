...
// Finds resident groups that have aged out of visible use.
// Unload candidates are written for CPU processing while preserving groups needed by current traversal results.
//==============================================================================
#version 460
