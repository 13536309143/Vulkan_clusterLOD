...
// Background fragment shader for sky or flat clear rendering.
// The pass runs behind cluster rendering and shares frame constants with the rest of the pipeline.
//==============================================================================
#version 460
