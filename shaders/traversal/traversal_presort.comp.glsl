...
// Optionally sorts or classifies traversal inputs before the main traversal pass.
// The pass improves coherence for later queue processing without changing LOD selection semantics.
//==============================================================================
#version 460
