...
// Seeds traversal queues from the visible render-instance list.
// The pass writes initial root tasks and resets counters before the main traversal kernel expands the hierarchy.
//==============================================================================
#version 460
